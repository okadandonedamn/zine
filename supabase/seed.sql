...
insert into boards (name, description, category, display_order) values
  ('映画板', '新作旧作問わず。ネタバレはスレッドのルールに従って。', 'film', 1),
  ('文学板', '小説・詩・批評。再読の発見、翻訳の比較、なんでも。', 'literature', 2),
  ('音楽板', 'ジャンル不問。名盤語りからライブレポまで。', 'music', 3),
  ('美術・展示板', '展覧会情報と感想。巡回情報の共有歓迎。', 'exhibition', 4),
  ('ファッション板', 'コレクション批評、ブランド史、装いの思想。', 'fashion', 5),
  ('雑談板', '文化系の雑談すべて。今日観たもの聴いたもの。', null, 6);
